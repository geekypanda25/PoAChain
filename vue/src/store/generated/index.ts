...
import PaddyMcDemopoaPaddyMcDemopoaDemopoa from './PaddyMc/demopoa/PaddyMc.demopoa.demopoa'
...
export default { 
  PaddyMcDemopoaPaddyMcDemopoaDemopoa: load(PaddyMcDemopoaPaddyMcDemopoaDemopoa, 'PaddyMc.demopoa.demopoa'),
